...
{
    camera->rotation.z += horizontal/3;
    camera->rotation.x += vertical/3;
    ...
    if (camera->rotation.x < -70) {
        camera->rotation.x = -70.0;
    }

    if (camera->rotation.x > 70.0) {
        camera->rotation.x = 70.0;
    }
